...
const info = "/JavaScript<br>";
// const infoNew = info.search(/s/i);
// const infoNew = info.match(/a/g);
// const infoNew = info.repeat(100);
const infoNew = info.charCodeAt(0);
// const infoNew = info.length;
// console.log(eval("infoNew"));
console.log(infoNew)
